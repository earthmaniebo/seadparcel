...
<head>
    ...
    <title>Data Analyst | Proof of Delivery Reports</title>
    <?php $page = "pod-reports" ?>
    ...
    <?php require_once "controller/dataAnalystController.php"; ?>
        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-">
                ...
                ?>
                        <h2  class="text-center">Proof of Delivery Reports</h2>
                        <br>
                        <div class="container">
                            <div class="row">
                        <!-- <div class="col-md-2">
                            ...
                            <form class="form-inline" role="form" action="pod.php" method="POST">
                        ...
                        <center><div id="shipment"><table class="table table-bordered table-striped text-center">
                            <?php $content .='<thead>
                                <tr>
                                    ...
                                    <th class="text-center">Relationship<br>To Consignee</th>
                                </tr>
                            </thead>
                            <tbody>';
                            ?>
                ...
                <?php $content .= '</tbody></table>';
                    ...
                    <br>
                    <form action="download-pod.php" method="POST" style="margin-left:85px">
