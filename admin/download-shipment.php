<?php
    ...
    if(isset($_POST["content"]))
    {
        ...
        $header = "<style>td{padding: 0 20px 0 20px; text-align:center;} th{text-align:center;}</style><h1 text-align='center'>Shipment Reports of Sead Parcel Services</h1><p text-align='center'><strong>Client: </strong>".$client."<br><strong>From:</strong> ". $_POST["fromDate"] . " <strong>To:</strong> ". $_POST["toDate"] . "<br><strong>Printed by:</strong> " . $_SESSION["firstName"] . " " . $_SESSION["lastName"]."</p><br><br>";
